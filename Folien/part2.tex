...
\begin{frame}{Bob}
\only<1>{\includegraphics[height=3cm]{Bob1.jpg}}

\only<2>{\includegraphics[height=3cm]{Bob2.jpg}}
\end{frame}

\begin{frame}{Alice}
\only<1>{\includegraphics[height=3cm]{Alice1.jpg}}

\only<2>{\includegraphics[height=3cm]{Alice2.jpg}}
\end{frame}
